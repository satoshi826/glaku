...
export const multiply = (mat1: Matrix, mat2: Matrix, dest: Matrix) => {
  const
...
export const scale = (mat: Matrix, vec: Vector, dest: Matrix) => {
  dest[0] = mat[0] * vec[0]
  dest[1] = mat[1] * vec[0]
  dest[2] = mat[2] * vec[0]
  dest[3] = mat[3] * vec[0]
...
export const translate = (mat: Matrix, vec: Vector, dest: Matrix) => {
...
export const rotate = (mat: Matrix, angle: number, axis: Vector, dest: Matrix) => {
...
export const lookAt = (eye: Vector, center: Vector, up: Vector, dest: Matrix) => {
...
export const perspective = (fov: number, aspect: number, near: number, far: number, dest: Matrix) => {
...
export const transpose = (mat: Matrix, dest: Matrix) => {
...
export const inverse = (mat: Matrix, dest: Matrix) => {
